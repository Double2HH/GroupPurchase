...
public class SortAdapter extends BaseAdapter implements SectionIndexer {
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(mContext).inflate(R.layout.item_citylist_city_selecter, null);
			viewHolder.tvTitle = (TextView) view.findViewById(R.id.item_citylist_title);
			viewHolder.tvLetter = (TextView) view.findViewById(R.id.item_citylist_catalog);
